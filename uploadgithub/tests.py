    ...
    while True:
        ...
        if names[-1].get_attribute('innerText') not in users_sent:
            ...
            try:
                ...
                try:
                    driver.find_element(By.XPATH,'//div[@class="c61n2bf6 mov749r8 ta68dy8c kpwa50dg m0cukt09 h8391g91 frvkd8zn iuajnvww denrs251 rtgkhd85 mt1396w6 qc9zwldo hsphh064"]')

                except:
                    while True:
                        try:
                            driver.find_element(By.XPATH, "//textarea[@type='text']")
                            break
                        except:
                ...
                driver.execute_script('document.getElementsByClassName("qi72231t tav9wjvu flwp5yud tghlliq5 gkg15gwv frfouenu bonavkto djs4p424 r7bn319e bdao358l fsf7x5fv s5oniofx m8h3af8h l7ghb35v kjdc1dyq kmwttqpk dnr7xe2t aeinzg81 cr00lzj9 s3jn8y49 g4tp4svg i85zmo3j pkdwr69g sc980dfb kq3l28k4 rc95jfaf fxk3tzhb tgm57n0e jl2a5g8c jez8cy9q gvxzyvdx om3e55n1 icdlwmnq rn8ck1ys f14ij5to bq6c9xl4 tb6i94ri gupuyl1y l3ldwz01 dl2p71xr h0c7ht3v j8nb7h05 gffp4m6x da5idqki g1y2g5el s6zx5hns tes86rjd a77x8hdp cgn1i9da q46jt4gp r5g9zsuq aesu6q9g e4ay1f3w")[1].click()')
